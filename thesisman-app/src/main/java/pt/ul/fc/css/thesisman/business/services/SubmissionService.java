...
public class SubmissionService {
  ...
  public Submission loadFinal(Long thesisId) throws ThesisNotFoundException, SubmissionNotFoundException {
  ...
  public List<Submission> loadProposals(Long thesisId) throws ThesisNotFoundException, SubmissionNotFoundException {
    Optional<Thesis> thesis = thesisCatalog.getBySubmissionId(thesisId);
    if (thesis.isEmpty())
      throw new ThesisNotFoundException("Thesis with id " + thesisId + " was not found!");
